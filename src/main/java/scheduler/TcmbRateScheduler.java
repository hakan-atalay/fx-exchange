...
import infrastructure.kafka.producer.ExchangeRateProducer;
...
public class TcmbRateScheduler {
	...
	private static final String TCMB_API_URL = System.getenv("TCMB_API_URL");
	...
	public void fetchRates() {
		...
		try {
			...
			for (int i = 0; i < currencies.getLength(); i++) {
				...
				ExchangeRateEvent event = new ExchangeRateEvent("TRY", code, rate, "TCMB");
